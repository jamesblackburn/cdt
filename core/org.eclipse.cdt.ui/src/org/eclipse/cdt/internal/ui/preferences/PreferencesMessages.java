...
//	public static String CEditorPreferencePage_ContentAssistPage_searchGroupCurrentProjectOption;
	...
	public static String CEditorColoringConfigurationBlock_asmMnemonic;
	public static String CEditorColoringConfigurationBlock_asmBranch;
	public static String CEditorColoringConfigurationBlock_asmAddAssemblyType;
	public static String CEditorColoringConfigurationBlock_asmRemoveAssemblyType;
	public static String CEditorColoringConfigurationBlock_asmDefaultAssemblyType;
	...
	public static String CEditorNewAssemblerTypeDialog_title;
	public static String CEditorNewAssemblerTypeDialog_name;
	public static String CEditorNewAssemblerTypeDialog_path;
	public static String CEditorNewAssemblerTypeDialog_fileBrowse;
	public static String CEditorNewAssemblerTypeDialog_description;
	public static String CEditorNewAssemblerTypeDialog_chooseFile;
	public static String CEditorNewAssemblerTypeDialog_errorTitle;
	public static String CEditorNewAssemblerTypeDialog_errorFile;
	public static String CEditorNewAssemblerTypeDialog_errorName;
	public static String CEditorNewAssemblerTypeDialog_errorMnemonic ;
	public static String CEditorNewAssemblerTypeDialog_TypeAlreadyExists;
	public static String CEditorNewAssemblerTypeDialog_NameMnsEmpty;
